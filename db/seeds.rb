...
service2 = Service.create!(activity: 'Ironing', hourly_fees: '22', description: 'whatever can be ironed', agency: agency1 )
service3 = Service.create!(activity: 'Cooking', hourly_fees: '35', description: 'A Chef is cooking in your own kitchen', agency: agency1 )
